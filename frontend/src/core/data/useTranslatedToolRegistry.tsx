...
const SplitPdfPanel = lazy(() => import("@app/tools/Split"));
const CompressPdfPanel = lazy(() => import("@app/tools/Compress"));
const OCRPanel = lazy(() => import("@app/tools/OCR"));
const ConvertPanel = lazy(() => import("@app/tools/Convert"));
const Sanitize = lazy(() => import("@app/tools/Sanitize"));
const AddPassword = lazy(() => import("@app/tools/AddPassword"));
const ChangePermissions = lazy(() => import("@app/tools/ChangePermissions"));
const RemoveBlanks = lazy(() => import("@app/tools/RemoveBlanks"));
const RemovePages = lazy(() => import("@app/tools/RemovePages"));
const ReorganizePages = lazy(() => import("@app/tools/ReorganizePages"));
import { reorganizePagesOperationConfig } from "@app/hooks/tools/reorganizePages/useReorganizePagesOperation";
const RemovePassword = lazy(() => import("@app/tools/RemovePassword"));
import {
  SubcategoryId,
  ToolCategoryId,
  ToolRegistry,
...
const AdjustContrast = lazy(() => import("@app/tools/AdjustContrast"));
...
const GetPdfInfo = lazy(() => import("@app/tools/GetPdfInfo"));
const AddWatermark = lazy(() => import("@app/tools/AddWatermark"));
const AddStamp = lazy(() => import("@app/tools/AddStamp"));
const AddAttachments = lazy(() => import("@app/tools/AddAttachments"));
const Merge = lazy(() => import("@app/tools/Merge"));
const EditTableOfContents = lazy(() => import("@app/tools/EditTableOfContents"));
const Repair = lazy(() => import("@app/tools/Repair"));
const SingleLargePage = lazy(() => import("@app/tools/SingleLargePage"));
const PageLayout = lazy(() => import("@app/tools/PageLayout"));
const UnlockPdfForms = lazy(() => import("@app/tools/UnlockPdfForms"));
const FormFill = lazy(() => import("@app/tools/formFill/FormFill"));
const AddFormField = lazy(() => import("@app/tools/AddFormField"));
const RemoveCertificateSign = lazy(() => import("@app/tools/RemoveCertificateSign"));
const RemoveImage = lazy(() => import("@app/tools/RemoveImage"));
const CertSign = lazy(() => import("@app/tools/CertSign"));
const BookletImposition = lazy(() => import("@app/tools/BookletImposition"));
const Flatten = lazy(() => import("@app/tools/Flatten"));
const Rotate = lazy(() => import("@app/tools/Rotate"));
const PdfTextEditor = lazy(() => import("@app/tools/pdfTextEditor/PdfTextEditor"));
const ChangeMetadata = lazy(() => import("@app/tools/ChangeMetadata"));
const Crop = lazy(() => import("@app/tools/Crop"));
const AddText = lazy(() => import("@app/tools/AddText"));
const AddImage = lazy(() => import("@app/tools/AddImage"));
const Annotate = lazy(() => import("@app/tools/Annotate"));
...
const Redact = lazy(() => import("@app/tools/Redact"));
const AdjustPageScale = lazy(() => import("@app/tools/AdjustPageScale"));
const ReplaceColor = lazy(() => import("@app/tools/ReplaceColor"));
const ScannerImageSplit = lazy(() => import("@app/tools/ScannerImageSplit"));
const OverlayPdfs = lazy(() => import("@app/tools/OverlayPdfs"));
...
const AddPageNumbers = lazy(() => import("@app/tools/AddPageNumbers"));
const RemoveAnnotations = lazy(() => import("@app/tools/RemoveAnnotations"));
import PageLayoutSettings from "@app/components/tools/pageLayout/PageLayoutSettings";
const ExtractImages = lazy(() => import("@app/tools/ExtractImages"));
const ExtractPages = lazy(() => import("@app/tools/ExtractPages"));
...
const ValidateSignature = lazy(() => import("@app/tools/ValidateSignature"));
const Compare = lazy(() => import("@app/tools/Compare"));
...
export function useTranslatedToolCatalog(): TranslatedToolCatalog {
  ...
  return useMemo(() => {
    const allTools: ToolRegistry = {
      ...
      addFormField: {
        icon: <LocalIcon icon="text-fields-rounded" width="1.5rem" height="1.5rem" />,
        name: t('home.addFormField.title', 'Add Form Field'),
        component: AddFormField,
        description: t('home.addFormField.desc', 'Add text fields or signature blocks to a PDF'),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.DOCUMENT_REVIEW,
        endpoints: ['add-text-field', 'add-signature-field'],
        synonyms: ['form', 'field', 'text field', 'signature field', 'acroform', 'fillable', 'sign block'],
      },
      changePermissions: {
