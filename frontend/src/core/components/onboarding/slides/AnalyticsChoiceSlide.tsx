...
export default function AnalyticsChoiceSlide({ analyticsError }: AnalyticsChoiceSlideProps): SlideConfig {
  return {
    ...
    title: i18n.t('analytics.title', 'Do you want to help make Y-Edit better?'),
    body: (
      <div className={styles.bodyCopyInner}>
        <Trans
          i18nKey="analytics.paragraph1"
          defaults="Y-Edit has opt-in analytics to help us improve the product. We do not track any personal information or file contents."
          components={{ strong: <strong /> }}
        />
        <br />
        <Trans
          i18nKey="analytics.paragraph2"
          defaults="Please consider enabling analytics to help Y-Edit grow and to allow us to understand our users better."
          components={{ strong: <strong /> }}
        />
        <br />
